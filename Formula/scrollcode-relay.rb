class ScrollcodeRelay < Formula
    ...
    on_macos do
      on_arm do
        url "https://github.com/ScrollCode-App/homebrew-scrollcode/releases/download/v0.1.0/ScrollCode_0.1.1_darwin_arm64.tar.gz"
        sha256 "ARM64_SHA256"
      end

      on_intel do
        url "https://github.com/ScrollCode-App/homebrew-scrollcode/releases/download/v0.1.0/ScrollCode_0.1.1_darwin_amd64.tar.gz"
        sha256 "AMD64_SHA256"
      end
    end
